...
export default function TerminalLog({ logs, onClear }) {
    return (
        <div className="bg-white rounded-xl border-2 border-slate-200 border-t-4 border-t-[#8B5CF6] p-5 flex flex-col shadow-sm h-[530px]">
            <div className="flex items-center justify-between mb-4 border-b-2 border-slate-100 pb-3">
                ...
                {logs.length > 0 && (
                    <button
                        ...
                        onClick={onClear}
                        className="text-[10px] font-mono tracking-wider text-slate-500 hover:text-[#8B5CF6] uppercase transition">
                        Clear Screen
                    </button>
                )}
            ...
            <div className="flex-1 overflow-y-auto font-mono text-xs space-y-2.5 pr-2">
                ...
                {logs.map((log, index) => {
                    let tagstyle = "text-[#8B5CF6] bg-purple-50 border border-purple-200";
                    ...
                    return (
                        <div
                            ...
                            <span
                                className="text-slate-400 mr-2">[{log.timestamp}]</span>
